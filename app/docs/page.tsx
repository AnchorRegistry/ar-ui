...
const ARTIFACT_TYPES = [
  ...
  { id: 11, group: 'Lifecycle',    name: 'EVENT',      status: 'active', desc: 'Human events and machine/agent processes.' },
  { id: 12, group: 'Transaction',  name: 'RECEIPT',    status: 'active', desc: 'Purchase, medical, financial, government receipts.' },
  { id: 13, group: 'Gated',        name: 'LEGAL',      status: 'v2',     desc: 'Contracts, patents, filings, disclosures.' },
  { id: 14, group: 'Gated',        name: 'ENTITY',     status: 'v2',     desc: 'Verified persons, companies, AI systems.' },
  { id: 15, group: 'Gated',        name: 'PROOF',      status: 'v4',     desc: 'ZK proofs, formal verifications, security audits.' },
  { id: 16, group: 'Self-service', name: 'RETRACTION', status: 'active', desc: 'Owner-initiated anchor retraction.' },
  { id: 17, group: 'Review',       name: 'REVIEW',     status: 'active', desc: 'Soft flag — anchor under review.' },
  { id: 18, group: 'Review',       name: 'VOID',       status: 'active', desc: 'Hard finding — subtree condemned.' },
  { id: 19, group: 'Review',       name: 'AFFIRMED',   status: 'active', desc: 'Exoneration — review resolved.' },
  { id: 20, group: 'Catch-all',    name: 'OTHER',      status: 'active', desc: 'Anything that does not fit above.' },
]
